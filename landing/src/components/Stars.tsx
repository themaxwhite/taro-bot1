...
/* Цены и состав сверены с бэкендом: app/subscriptions.py (тарифы),
   app/energy.py (пакеты и суточная энергия), app/yookassa (оплата).
   Раньше здесь были Telegram Stars — механики, которой в продукте нет
   вовсе; оплата идёт через ЮKassa, и на её странице карту как раз
   вводят, так что прежнее «без карт и реквизитов» было неверно. */
const tiers = [
  {
    name: "Бесплатно",
    price: "0",
  ...
  },
  {
    ...
    items: [
      ...
      "Пакет энергии разово — от 89 ₽, не сгорает",
      "Оплата через ЮKassa, подтверждается на сервере",
    ],
    cta: true,
  },
];
  ...
  return (
    <Section id="pricing">
      ...
      >
        ...
        Платёж проходит через ЮKassa и перепроверяется на сервере прямым
        запросом к их API, а не «на доверии» к вебхуку.
      </SectionIntro>
