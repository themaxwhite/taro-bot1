...
const stats = [
  ...
  { value: 3, suffix: "", label: "типа расклада" },
  { value: 0, suffix: " ₽", label: "базовый расклад" },
];
        ...
        <div>
          ...
          <Reveal delay={280}>
            <p className="mt-8 max-w-xl text-pretty text-base leading-relaxed text-ink-muted sm:text-lg">
              Карта дня, расклад на любовь, расклад на будущее — иллюстрированная
              колода из {site.deckSize} карт и толкование, собранное вокруг
              вашего вопроса. Открывается прямо в Telegram, ставить нечего.
            </p>
          </Reveal>
