    ...
    <div className={styles.screen}>
      ...
      <div className={styles.content}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            сведения об оплате: дата, сумма и статус платежа, оплаченный тариф. Платёжные
            данные — реквизиты карты или банковского счёта при оплате через СБП — нам не
            передаются и не хранятся ни при каких условиях: они вводятся на стороне
            платёжного сервиса;
          </li>
          <li>
