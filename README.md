...
- Backend: полная колода (78 карт, у каждой — своя SVG-эмблема в едином
  стиле), эндпоинт розыгрыша расклада, валидация Telegram `initData`
...
- AI-толкование расклада (Anthropic API, с учётом вопроса и «тем» из
  профиля) и дневное мотивирующее пожелание — оба со статичным fallback,
  если `ANTHROPIC_API_KEY` не настроен
