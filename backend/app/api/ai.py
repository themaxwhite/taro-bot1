...
async def interpret_spread(
    ...
    generated = await generate_text(
        system_prompt=(
            ...
            "расклада на русском языке, 120-200 слов, обычным текстом без "
            "заголовков и списков. Опирайся на позиции карт и их сочетание "
            "между собой, а не только на каждую карту по отдельности. Если "
            "дан вопрос пользователя — явно свяжи толкование с ним. Не "
            "давай медицинских, юридических или финансовых советов, не "
            "утверждай ничего как гарантированный факт о будущем."
        ),
        user_prompt=(
